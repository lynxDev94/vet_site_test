...
import Lottie from "lottie-react"; // ✅ Modern compatible Lottie
...
export const BentoGridItem = ({
  ...
  const leftLists = ["SEO", "WordPress", "React.js"];
  const rightLists = ["E-commerce", "Next.js", "Typescript"];
  const [copied, setCopied] = useState(false);

  const handleCopy = () => {
    navigator.clipboard.writeText("contact@lynxpounce.com");
    setCopied(true);
  };
